# dog-vision-multiclass-classification
...
So that's what we are going to focus on in this project. We are taking dataet from the kaggle competion. 
...
Rest of the details for every step inside our project can be found inside the Colab notebook. I have tried to keep the colab notebook as communicative as possible. Hope people reading this find it useful.
